<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>运维人员</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="2" ><el-button type="primary" @click="getUserXxList">查询</el-button></el-col>
        <el-col :span="6" ><el-button type="success" @click="showAddUserDialog">录入新运维账号</el-button></el-col>
      </el-row>
      ...
      return{
        ...
        checkUserFormRules:{
          nickname:[
            ...
            { min: 1, max: 10, message: '请输入1~10位以内的字符，且不能包括特殊字符', trigger: 'blur' },
          ],
          password:[
